...
\author{Clayton Pierce\\ Independent Researcher\\ \texttt{bamer78@gmail.com}}
\date{}
...
Code and analysis scripts are at
\url{https://github.com/bigshotClay/SuperVend9000}; the archived run databases
(679 SQLite files) are the \texttt{data-v1} release asset at
\url{https://github.com/bigshotClay/SuperVend9000/releases/tag/data-v1},
extracted at the repository root. \texttt{compute\_results.py} regenerates the core
